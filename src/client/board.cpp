...
Board::Board(QGraphicsScene * scene,MainWindow * window) : QGameItem(scene,window)
{
    ...
    blocks[1]->setPos(0,corner_h + vblock_h * 6);
    ...
    blocks[2]->setPos(0,corner_h + vblock_h * 5);
    ...
    blocks[3]->setPos(0,corner_h + vblock_h * 4);
    ...
    blocks[4]->setPos(0,corner_h + vblock_h * 3);
    ...
    blocks[5]->setPos(0,corner_h + vblock_h * 2);
    ...
    blocks[6]->setPos(0,corner_h + vblock_h * 1);
    ...
    blocks[7]->setPos(0,corner_h + vblock_h * 0);
    ...
    blocks[16]->setPos(corner_w + hblock_w * 7,0);
    ...
    blocks[17]->setPos(corner_w + hblock_w * 7,corner_h);
    ...
    blocks[18]->setPos(corner_w + hblock_w * 7,corner_h + vblock_h * 1);
    ...
    blocks[19]->setPos(corner_w + hblock_w * 7,corner_h + vblock_h * 2);
    ...
    blocks[20]->setPos(corner_w + hblock_w * 7,corner_h + vblock_h * 3);
    ...
    blocks[21]->setPos(corner_w + hblock_w * 7,corner_h + vblock_h * 4);
    ...
    blocks[22]->setPos(corner_w + hblock_w * 7,corner_h + vblock_h * 5);
    ...
    blocks[23]->setPos(corner_w + hblock_w * 7,corner_h + vblock_h * 6);
    ...
    blocks[26]->setPos(corner_w + hblock_w * 5,corner_h + vblock_h * 7);
    ...
    blocks[30]->setPos(corner_w + hblock_w * 1,corner_h + vblock_h * 7);
