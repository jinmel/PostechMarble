...
Board::Board()
{
    ...
    blocks[0] = new CornerBlock(DORM); // dorm
    ...
    blocks[4] = new FireFridayBlock(TONGZIP); //통집
    ...
    blocks[8] = new CornerBlock(MUINDO); // 무인도
    ...
    blocks[16] = new CornerBlock(PLURALMAJOR); //복수전공
    ...
    blocks[20] = new FireFridayBlock(SEOULJONGBIN); // 설종빈
    ...
    blocks[24] = new CornerBlock(61CALL); //61콜
